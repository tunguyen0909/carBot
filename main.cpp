...
char Data_TX_CamBien[] = "000904";
char Data_TX_XLA[] = "000904";
bool flag_XLA = 0;
bool flag_CamBien = 0;
...
int main(int argc, char** argv)
{
        ...
        for(;;)
        {
            if(flag_XLA == 1 && flag_CamBien == 0)
            {
                successFlag=com.Write(Data_TX_XLA);
                std::cout<<"[XLA] = "<< flag_XLA << "\n";
                std::cout<<"[CamBien] = "<< flag_CamBien << "\n";
                std::cout << Data_TX_XLA << "\n";
                flag_XLA = 0;
                flag_CamBien = 0;
            }

            else if(flag_XLA == 1 && flag_CamBien == 1)
            {
                successFlag=com.Write(Data_TX_XLA);
                std::cout<<"[XLA] = "<< flag_XLA << "\n";
                std::cout<<"[CamBien] = " << flag_CamBien << "\n";
            ...
            else if(flag_XLA == 0 && flag_CamBien == 1)
            {
                successFlag=com.Write(Data_TX_CamBien);
                std::cout<<"[XLA] = "<< flag_XLA << "\n";
                std::cout<<"[CamBien] = "<< flag_CamBien << "\n";
                std::cout << Data_TX_CamBien << "\n";
                flag_XLA = 0;
                flag_CamBien = 0;
            }

            /*
            else if(flag_XLA == 0 && flag_CamBien == 0)
            {
                successFlag=com.Write(DC_TX_left_1);
                std::cout<<"[XLA]"<< flag_XLA << "\n";
                std::cout<<"[CamBien]"<< flag_CamBien << "\n";
            ...
            if (!person_list[b].empty()) {
                ...
                if (cen_bottom.x <= tmp_min_x_cen_11){
                    //char s[] = "070907"; //left
                        ...
                        //std::cout << DC_TX_left_1 << "\n";
                        strcpy(Data_TX_XLA,DC_TX_left_1);
                        flag_XLA = 1;
                    ...
                    //    std::cout << DC_TX_right_1 << "\n";
                        ...
                        strcpy(Data_TX_XLA,DC_TX_right_1);
                        flag_XLA = 1;
                    //}
                    color_x = cv::Scalar(255, 0, 0);
                }
                    ...
                    //}
                        strcpy(Data_TX_XLA,DC_TX_left_2);
                        flag_XLA = 1;
                    ...
                    //    std::cout << DC_TX_right_2 << "\n";
                        ...
                        strcpy(Data_TX_XLA,DC_TX_right_2);
                        flag_XLA = 1;
                   // }
                    color_x = cv::Scalar(0, 255, 255);
                }
                    ...
                    //    std::cout << DC_TX_left_3 << "\n";
                        strcpy(Data_TX_XLA,DC_TX_left_3);
                        flag_XLA = 1;
                    //}
                    ...
                    //    std::cout << DC_TX_right_3 << "\n";
                        strcpy(Data_TX_XLA,DC_TX_right_3);
                        flag_XLA = 1;
                    //}
                    color_x = cv::Scalar(0, 255, 255);
                }
...
void * HCSR04_thread(void *arg)
{
    for(;;)
    {
                ...
                {
                    //left
                    strcpy(Data_TX_CamBien,hcsr04_TX_left);
                    flag_CamBien = 1;
                }
                else if(hcsr04_dis_1 >= 22.0 && hcsr04_dis_2 <= 22.0)
                {
                    //right
                    strcpy(Data_TX_CamBien,hcsr04_TX_right);
                    flag_CamBien = 1;
                }
                else if(hcsr04_dis_1 <= 22.0 && hcsr04_dis_2 <= 22.0)
                {
                    //turn right
                    strcpy(Data_TX_CamBien,hcsr04_TX_turn_right);
                    flag_CamBien = 1;
                }
